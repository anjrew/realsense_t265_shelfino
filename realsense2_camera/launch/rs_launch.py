...
configurable_parameters = [
    {"name": "camera_name", "default": "", "description": "camera unique name"},
    {
        "name": "node_name",
        "default": "t265_node",
        "description": "The name of the ROS2 node",
    },
    {
        "name": "node_namespace",
        "default": "",
        "description": "The namespace of the ROS2 node",
    },
    {
        "name": "serial_no",
        "default": "''",
    ...
    {"name": "tf_ns", "default": "tf_launch_ns", "description": "The tf namespace"},
    {
        "name": "odom_tf",
        "default": "odom_tf",
        "description": "The tf for odom_frame (WITH namespace)",
    },
    {
        "name": "base_frame_id",
        "default": "base_link",
        "description": "The base frame id (WITH namespace)",
    },
    {
    ...
    # {'name': 'odom_frame_id',                'default': 'odom', 'description': 'The odom frame id (WITH namespace)'},
    # "odom_frame_id": "odom", # Dont think this is used
]
